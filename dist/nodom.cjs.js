...
class ModuleFactory {
    ...
    static load(modulePath) {
        return __awaiter(this, void 0, void 0, function* () {
            let m = yield (function (t) { return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(t)); }); })(modulePath);
            if (m) {
                //通过import的模块，查找模块类
...
class Module {
    ...
    active() {
        ...
        if (this.state === exports.EModuleState.UNMOUNTED) {
            this.state = exports.EModuleState.READY;
        }
        Renderer.add(this);
    }
    /**
